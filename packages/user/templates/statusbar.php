<div id="status">
	...
	<div id="ui_statusbar_forumstatus">
		<span title="<?php echo $user->signature; ?>"><?php echo ((strlen(trim($user->signature)) > 0) ? ((mb_strlen($user->signature, 'UTF8') > 22) ? mb_substr($user->signature, 0, 19, 'UTF8') . '...' : $user->signature) : 'Ingen status'); ?></span><div id="status_icon_edit">+</div>
	</div>
</div>