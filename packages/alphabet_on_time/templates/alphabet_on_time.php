...
<div id="alphabet_container">
	...
	<input type="text" id="alphabet_input" />
</div>

<p id="alphabet_focus">
	Klicka i rutan med alfabetet!
</p>

<p id="alphabet_timer">
	<span id="alphabet_timer_seconds">00.00</span>s (<span id="alphabet_timer_kps">0</span> tecken per sekund)
</p>

<p id="alphabet_instructions">
	Tiden börjar räknas när du skriver första bokstaven.
</p>
